...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (loginForm) {
      loginForm.addEventListener("submit", function (event) {
          ...
          fetch('https://infinitytrabalheja-lpsgjk4ji-duda-silvaas-projects.vercel.app/login', {
              method: 'POST',
              headers: {
  ...
  if (registerForm) {
      registerForm.addEventListener("submit", function (event) {
          ...
          fetch('https://infinitytrabalheja-lpsgjk4ji-duda-silvaas-projects.vercel.app/register', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (formSolicitacao) {
      formSolicitacao.addEventListener("submit", function (event) {
          ...
          fetch('https://infinitytrabalheja-lpsgjk4ji-duda-silvaas-projects.vercel.app/solicitacao-orcamento', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
...
if (suporteForm) {
    suporteForm.addEventListener("submit", function (event) {
        ...
        fetch('https://infinitytrabalheja-lpsgjk4ji-duda-silvaas-projects.vercel.app/suporte', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
